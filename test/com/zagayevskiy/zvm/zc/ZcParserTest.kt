...
internal class ZcParserTest(private val test: TestData) {
    ...
    companion object {
        ...
        fun data() = listOf(
                ...
                "fn f(i: int): byte { return cast<byte>(i); }" expect program(fn("f", args = listOf(Arg("i") withType "int"), body = AstBlock(listOf(AstFunctionReturn(AstHardCastExpr("i".id, UnresolvedType.Simple("byte"))))))),
